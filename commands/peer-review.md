---
name: peer-review
description: Critically evaluate peer review findings from another team lead or model by verifying each issue against actual code. Use when the user says "peer review", "review these findings", "evaluate this feedback", "check these comments", or pastes external code review feedback to be validated.
---
