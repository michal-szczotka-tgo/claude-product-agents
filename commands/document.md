---
name: document
description: Update project documentation after code changes by verifying actual implementation and updating CHANGELOG and docs. Use when the user says "update docs", "document this", "update documentation", "add changelog entry", or after completing a feature/bugfix that needs documentation.
---
